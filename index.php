...
<head>
	...
	<title>Musholla Faidhol Barokah</title>
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="http://purniawanagus.epizy.com/musholla/" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="http://purniawanagus.epizy.com/musholla/" class="brand-link">
				<img src="dist/img/masjid.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light">FAIDHOL BAROKAH</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="http://purniawanagus.epizy.com/musholla/" class="d-block">
							<?php echo $data_nama; ?>
						</a>
        ...
        ?>
						<li class="nav-item">
							<a href="http://purniawanagus.epizy.com/musholla/" class="nav-link">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=lap_musholla" class="nav-link">
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              ...
              //Musholla in
              case 'i_data_km':
                  include "bendahara/musholla/in/data_kas.php";
                  break;
              case 'i_add_km':
                  include "bendahara/musholla/in/add_kas.php";
                  break;
              case 'i_edit_km':
                  include "bendahara/musholla/in/edit_kas.php";
                  break;
              case 'i_del_km':
                  include "bendahara/musholla/in/del_kas.php";
                  break;

              //Musholla out
              case 'o_data_km':
                  include "bendahara/musholla/out/data_kas.php";
                  break;
              case 'o_add_km':
                  include "bendahara/musholla/out/add_kas.php";
                  break;
              case 'o_edit_km':
                  include "bendahara/musholla/out/edit_kas.php";
                  break;
              case 'o_del_km':
                  include "bendahara/musholla/out/del_kas.php";
                  break;

              case 'rekap_km':
                  include "bendahara/musholla/rekap_kas.php";
                  break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Musholla Faidhol Barokah
			</div>
			Copyright &copy;
			<a target="_blank" href="http://purniawanagus.epizycom">
				<strong> Agus Purniawan</strong>
			</a>
			All rights reserved.
		</footer>
