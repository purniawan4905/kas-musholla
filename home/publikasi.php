<?php
  $sql = $koneksi->query("SELECT SUM(masuk) as tot_masuk  from kas_musholla where jenis='Masuk'");
  while ($data= $sql->fetch_assoc()) {
    $masuk=$data['tot_masuk'];
  }

  $sql = $koneksi->query("SELECT SUM(keluar) as tot_keluar  from kas_musholla where jenis='Keluar'");
  while ($data= $sql->fetch_assoc()) {
      ...
      <div class="row">
        <div class="col-lg-6 col-6">
          ...
          <div class="small-box bg-info">
            ...
            <a href="?page=publikasi/kas/muasholla" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-6 col-6">
